  ...
  async function finish(id:GameId,r:Result){
    if(activeRun){
      ...
      try {
        ...
        setRankedSubmission({state:"verified",score:result.score,xp:result.xp,rank:result.rank,previousBest:result.previousBest,improvement:result.improvement,personalBest:result.personalBest,ratingDelta:result.ratingDelta,rating:result.rating,grade:result.grade,nextGrade:result.nextGrade,ratingToNext:result.ratingToNext,progressPercent:result.progressPercent,playerUsername:profile?.username || "You",...(activeRun.challengeToken && "opponentScore" in result ? {opponentUsername:result.opponentUsername,opponentScore:result.opponentScore,winnerUsername:result.winnerUsername} : {})});
